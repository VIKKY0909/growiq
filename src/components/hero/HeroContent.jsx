      ...
      {/* <motion.div
        ...
        animate={{
          ...
          boxShadow: darkMode
            ...
            : [
                "0 0 0px rgba(15,16,57,0)",
                "0 0 30px rgba(15,16,57,.18)",
                "0 0 0px rgba(15,16,57,0)",
              ],
        }}
        transition={{
        ...
        className={`
          ...
          px-5 py-2 text-sm font-medium backdrop-blur-md

          ${
            darkMode
              ? "bg-[#D5D93B]/10 border-[#D5D93B]/30 text-[#D5D93B]"
              : "bg-[#0F1039]/5 border-[#0F1039]/15 text-[#0F1039]"
          }
        `}
      >
